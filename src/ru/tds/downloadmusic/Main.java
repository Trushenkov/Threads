 ...
 */
public class Main {
    private static final String IN_FILE_TXT = "src\\ru\\tds\\downloadmusic\\inFile.txt";
    private static final String OUT_FILE_TXT = "src\\ru\\tds\\downloadmusic\\outFile.txt";
